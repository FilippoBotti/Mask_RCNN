...
class ModaNetDataset(torch.utils.data.Dataset):
    def __init__(self, dir_path, ann_file_name, classes, size, transforms=None):
    ...
    #             # accessorio presente lo aggiungo alla maschera degli accessori (non è detto sia singolo, posso avere sia occhiali che cintura)
    #             print(ann['category_id'])
    #             accessory_mask.append(current_mask)
